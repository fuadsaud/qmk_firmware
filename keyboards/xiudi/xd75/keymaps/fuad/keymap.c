...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_META] = {
    ...
    { ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , D_GNOME , UG_HUEU  , UG_SATU , UG_VALU , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ },
    { ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , UG_HUED  , UG_SATD , UG_VALD , ___x___ , D_MACOS , ___x___ , ___x___ , ___x___ , ___x___ },
    { ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , UG_PREV  , UG_TOGG , UG_NEXT , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ },
  }
};
