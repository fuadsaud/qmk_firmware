...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_RAISE_GNOME] = {
    ...
    { _______ , G_WMV_L , G_WIN_RST , G_WIN_MAX , G_WMV_R , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______  , G_SSS   , G_WSS   },
  ...
  [LAYER_RAISE_I3] = {
    ...
    { _______ , I_WMV_L , I_WMV_D   , I_WMV_U   , I_WMV_R , _______ , _______ , _______ , _______ , I_WIN_MAX , I_WIN_L , I_WIN_D , I_WIN_U  , I_WIN_R , I_WSS   },
    { _______ , I_MON_L , I_MON_D   , I_MON_U   , I_MON_R , _______ , G_GLEFT , _______ , G_GRIGH , KC_LEFT   , KC_DOWN , KC_UP   , KC_RIGHT , _______ , I_SSS   },
    { _______ , _______ , _______   , G_GLEFT   , G_GRIGH , _______ , G_BACK  , ___x___ , G_FRWD  , _______   , G_BACK  , G_FRWD  , _______  , _______ , _______ },
    { _______ , _______ , _______   , _______   , _______ , I_LNCHR , I_MPRV  , _______ , I_MNXT  , _______   , _______ , _______ , _______  , _______ , _______ },
  },
