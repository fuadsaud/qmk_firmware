...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_QWERTY_L] = {
    ...
    { L_LOWER  , KC_LGUI , KC_LALT , L_C_BRO , L_LOWER , L_SPC , L_VOLD  , KC_MPLY , L_VOLU  , L_BSP , L_RAISE , HYP_BRC , KC_LEAD , KC_HYPR , L_META  },
  },
[LAYER_QWERTY_M] = {
    { KC_GRV   , KC_1    , KC_2    , KC_3    , KC_4    , KC_5  , KC_MINS , KC_ESC  , KC_EQL  , KC_6  , KC_7    , KC_8    , KC_9    , KC_0    , KC_BSLS },
    { KC_TAB   , KC_Q    , KC_W    , KC_E    , KC_R    , KC_T  , KC_LBRC , KC_BSLS , KC_RBRC , KC_Y  , KC_U    , KC_I    , KC_O    , KC_P    , KC_QUOT },
    ...
    { M_LOWER  , KC_LCTL , KC_LALT , M_C_BRO , M_LOWER , M_SPC , M_VOLD  , KC_MPLY , M_VOLU  , M_BSP , M_RAISE , HYP_BRC , KC_LEAD , KC_HYPR , M_META  },
  },
  ...
  [LAYER_RAISE_L] = {
    ...
    { _______ , _______ , _______   , _______   , _______ , _______ , KC_MPRV , ___x___ , KC_MNXT , KC_DEL  , _______ , KC_MS_L , KC_MS_D  , KC_MS_R , KC_WH_D },
  },
  ...
  [LAYER_RAISE_M] = {
    ...
    { _______ , _______ , _______   , _______   , _______ , _______ , KC_MRWD , KC_SLCK , KC_MFFD , _______ , _______ , KC_MS_L , KC_MS_D  , KC_MS_R , KC_WH_D },
  },
